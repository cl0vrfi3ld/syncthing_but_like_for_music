...
//               destinations: appRoutes.map((route) => NavigationRailDestination(icon: route["icon"], label: route["name"])).toList(),
...
import 'package:flutter/material.dart';
import 'package:syncthing_but_like_for_music/src/rust/api/simple.dart';
